...
*   **Интеграция с Google Sheets:** (если это так) Выгрузка данных в таблицу для удобного анализа.
*   **Асинхронная обработка:** (если реализовано) Ответы бота не блокируют друг друга.
